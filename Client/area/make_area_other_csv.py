...
min_lon = float(os.getenv("MIN_LON")) + 0.06
max_lon = float(os.getenv("MAX_LON")) + 0.06
...
if args.num == 1:
    ...
    file_name = "area_10_10_other.csv"
    current_lat = min_lat
    current_lon = min_lon
    step = 0.010
    while current_lat <= max_lat - step:
